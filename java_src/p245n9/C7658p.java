...
public final class C7658p {
    ...
    /* renamed from: a */
    public static void m6290a(int i) throws InvalidAlgorithmParameterException {
        if (i != 16 && i != 32) {
    ...
    /* renamed from: b */
    public static String m6289b(String str) {
    ...
    /* renamed from: c */
    public static void m6288c(int i) throws GeneralSecurityException {
        if (i >= 0 && i <= 0) {
            return;
        }

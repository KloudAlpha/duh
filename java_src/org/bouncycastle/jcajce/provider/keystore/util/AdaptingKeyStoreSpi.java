...
public class AdaptingKeyStoreSpi extends KeyStoreSpi {
    ...
    public AdaptingKeyStoreSpi(InterfaceC6660c interfaceC6660c, KeyStoreSpi keyStoreSpi) {
        this.jksStore = new JKSKeyStoreSpi(interfaceC6660c);
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        if (!C9008g.m4105b(COMPAT_OVERRIDE)) {

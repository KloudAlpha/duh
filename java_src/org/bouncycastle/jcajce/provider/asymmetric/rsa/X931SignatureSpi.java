...
public class X931SignatureSpi extends SignatureSpi {
    ...
    public X931SignatureSpi(InterfaceC5631p interfaceC5631p, InterfaceC5610a interfaceC5610a) {
        this.signer = new C0292m(interfaceC5631p, interfaceC5610a);
    }

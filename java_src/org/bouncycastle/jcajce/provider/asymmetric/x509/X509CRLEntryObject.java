...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    /* renamed from: c */
    private C4605o0.C4606a f19551c;
    ...
    private C4619u getExtension(C5375o c5375o) {
        C4621v m10058x = this.f19551c.m10058x();
        if (m10058x != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            ...
            return this.f19551c.equals(x509CRLEntryObject.f19551c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f19551c.m9442w("DER");
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        ...
        if (extension != null) {
            try {
                ...
                throw new IllegalStateException(C0305a.m14494d(e, C0048o.m14987g("Exception encoding: ")));
            }
        }
        return null;
    }
    ...
    public Date getRevocationDate() {
        return C4620u0.m10048y(this.f19551c.f11016b.mo9386K(1)).m10049x();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f19551c.m10060A().m9449L();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f19551c.m10058x() != null;
    }
                    ...
                    while (true) {
                        ...
                        while (m10047A.hasMoreElements()) {
                            ...
                            if (abstractC5379p != null) {
                                ...
                                stringBuffer.append(") ");
                                try {
                                    if (c5375o.m9412C(C4619u.f11065Z)) {
                                        m10043x = C4600m.m10066x(C5349g.m9476I(c5363k.m9455i()));
                                    } else if (c5375o.m9412C(C4619u.f11050K1)) {

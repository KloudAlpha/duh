...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof C8054f ? new BCECGOST3410PrivateKey((C8054f) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    @Override // org.bouncycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi, java.security.KeyFactorySpi
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof C8055g ? new BCECGOST3410PublicKey((C8055g) keySpec, BouncyCastleProvider.CONFIGURATION) : keySpec instanceof ECPublicKeySpec ? new BCECGOST3410PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
    ...
    public PrivateKey generatePrivate(C12368p c12368p) throws IOException {
        ...
        if (c5375o.m9412C(InterfaceC7045a.f17061l)) {
            return new BCECGOST3410PrivateKey(c12368p);
        }
        if (c5375o.m9412C(InterfaceC7045a.f17074y)) {
            return new BCECGOST3410PrivateKey(c12368p);
        }
        if (c5375o.m9412C(InterfaceC7045a.f17073x)) {
            return new BCECGOST3410PrivateKey(c12368p);
        }
    ...
    public PublicKey generatePublic(C4603n0 c4603n0) throws IOException {
        ...
        if (c5375o.m9412C(InterfaceC7045a.f17061l)) {
            return new BCECGOST3410PublicKey(c4603n0);
        }
        if (c5375o.m9412C(InterfaceC7045a.f17074y)) {
            return new BCECGOST3410PublicKey(c4603n0);
        }

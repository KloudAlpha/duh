...
public class SignatureSpi extends java.security.SignatureSpi implements InterfaceC12366n, InterfaceC4630z0 {
    ...
    private InterfaceC5627l signer = new C5676n(13);
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof InterfaceC7708c) {
            ...
            try {
                generatePublicKeyParameter = ECUtil.generatePublicKeyParameter(BouncyCastleProvider.getPublicKey(C4603n0.m10064x(publicKey.getEncoded())));

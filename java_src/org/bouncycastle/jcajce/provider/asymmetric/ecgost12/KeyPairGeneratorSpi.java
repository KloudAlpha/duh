...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    private void init(C6208k c6208k, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        C5443h m7298b = C7046b.m7298b(c6208k.f15248a);
        if (m7298b != null) {
            this.ecParams = new C8052d(C7046b.m7297c(c6208k.f15248a), m7298b.f13428c, m7298b.m9375x(), m7298b.f13430q, m7298b.f13431x, m7298b.m9376A());
            C10779y c10779y = new C10779y(new C10777x(new C10715a0(c6208k.f15248a, m7298b), c6208k.f15248a, c6208k.f15249b, c6208k.f15250c), secureRandom);
            this.param = c10779y;
            this.engine.m4694a(c10779y);
            this.initialised = true;
            return;
        }
        StringBuilder m14987g = C0048o.m14987g("unknown curve: ");
        m14987g.append(c6208k.f15248a);
    ...
    public KeyPair generateKeyPair() {
        if (this.initialised) {
            ...
            if (obj instanceof C8053e) {
                ...
                BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey = new BCECGOST3410_2012PublicKey(this.algorithm, c10721c0, c8053e);
                return new KeyPair(bCECGOST3410_2012PublicKey, new BCECGOST3410_2012PrivateKey(this.algorithm, c10718b0, bCECGOST3410_2012PublicKey, c8053e));
            } else if (obj == null) {
                return new KeyPair(new BCECGOST3410_2012PublicKey(this.algorithm, c10721c0), new BCECGOST3410_2012PrivateKey(this.algorithm, c10718b0));
            } else {
                ECParameterSpec eCParameterSpec = (ECParameterSpec) obj;
                BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey2 = new BCECGOST3410_2012PublicKey(this.algorithm, c10721c0, eCParameterSpec);
                return new KeyPair(bCECGOST3410_2012PublicKey2, new BCECGOST3410_2012PrivateKey(this.algorithm, c10718b0, bCECGOST3410_2012PublicKey2, eCParameterSpec));
            }
        }

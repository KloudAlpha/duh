...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, InterfaceC7707b, InterfaceC7719n {
    public static final long serialVersionUID = 7245981689601667138L;
    private String algorithm;
    private transient PKCS12BagAttributeCarrierImpl attrCarrier;

    /* renamed from: d */
    private transient BigInteger f19544d;
    ...
    public BCECGOST3410_2012PrivateKey(String str, C10718b0 c10718b0) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f19544d = c10718b0.f26303d;
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f19544d = eCPrivateKey.getS();
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f19544d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f19544d = bCECGOST3410_2012PrivateKey.f19544d;
    ...
    public BCECGOST3410_2012PrivateKey(C12368p c12368p) throws IOException {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
    ...
    private C5392t0 getPublicKeyDetails(BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey) {
        return C4603n0.m10064x(bCECGOST3410_2012PublicKey.getEncoded()).f11003c;
    }
    ...
    */
    private void populateFromPrivKeyInfo(C12368p c12368p) throws IOException {
        ...
        AbstractC5391t m55y;
        BigInteger m9449L;
        AbstractC5391t mo52g = c12368p.f29889c.f10933c.mo52g();
        if ((mo52g instanceof AbstractC5397v) && (AbstractC5397v.m9404J(mo52g).size() == 2 || AbstractC5397v.m9404J(mo52g).size() == 3)) {
            ...
            this.ecSpec = new C8052d(C7046b.m7297c(this.gostParams.f17089b), EC5Util.convertCurve(m13793N0.f19493a, m13793N0.f19494b), EC5Util.convertPoint(m13793N0.f19495c), m13793N0.f19496d, m13793N0.f19497e);
            C5338c1 c5338c1 = new C5338c1(c12368p.f29890d.f13338b);
            byte[] bArr = c5338c1.f13338b;
            if (bArr.length != 32 && bArr.length != 64) {
                ...
                if (m55y2 instanceof C5366l) {
                    ...
                    this.f19544d = new BigInteger(1, C9001a.m4119s(AbstractC5379p.m9431J(m55y2).f13338b));
                    return;
                }
            } else {
                m9449L = new BigInteger(1, C9001a.m4119s(c5338c1.f13338b));
            }
        } else {
            ...
            if (abstractC5391t instanceof C5375o) {
                ...
                if (namedCurveByOid == null) {
                    C5443h m7298b = C7046b.m7298b(m9438L);
                    eCParameterSpec = new C8052d(C7046b.m7297c(m9438L), EC5Util.convertCurve(m7298b.f13428c, m7298b.m9376A()), EC5Util.convertPoint(m7298b.m9375x()), m7298b.f13430q, m7298b.f13431x);
                } else {
    ...
    */
    public byte[] getEncoded() {
        ...
        if (this.gostParams != null) {
            ...
            try {
                return new C12368p(new C4578b(c5375o, this.gostParams), new C5338c1(bArr), null, null).m9442w("DER");
        ...
        try {
            if (eCParameterSpec instanceof C8052d) {
                ...
                return new C12368p(new C4578b(c5375o, c5441f2.f13422b), c1564a.f4734b, null, null).m9442w("DER");
            } else {
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f19544d, engineGetSpec());
    }

    public BCECGOST3410_2012PrivateKey(String str, C10718b0 c10718b0, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, ECParameterSpec eCParameterSpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
    ...
    public BCECGOST3410_2012PrivateKey(String str, C10718b0 c10718b0, BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey, C8053e c8053e) {
        ECParameterSpec eCParameterSpec;
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        C10775w c10775w = c10718b0.f26419c;
    ...
    public BCECGOST3410_2012PrivateKey(C8054f c8054f) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f19544d = c8054f.f19498c;

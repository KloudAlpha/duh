...
public class ECGOST2012SignatureSpi256 extends SignatureSpi implements InterfaceC12366n, InterfaceC4630z0 {
    private int size = 64;
    private int halfSize = 32;
    private InterfaceC5631p digest = new C7061f();
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (privateKey instanceof InterfaceC7706a) {
            ...
            if (c10781z.f26419c.f26405q.bitLength() <= 256) {
                this.digest.reset();

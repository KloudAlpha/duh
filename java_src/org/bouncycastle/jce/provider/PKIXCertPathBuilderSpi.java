        ...
        try {
            ...
            if (CertPathValidatorUtilities.isIssuerTrustAnchor(x509Certificate, c4655s.f11151K1, c4655s.m10034b())) {
                try {
                    ...
                    try {
                        PKIXCertPathValidatorResult pKIXCertPathValidatorResult = (PKIXCertPathValidatorResult) pKIXCertPathValidatorSpi.engineValidate(engineGenerateCertPath, c4653r);

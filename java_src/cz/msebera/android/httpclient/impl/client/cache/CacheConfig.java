...
public class CacheConfig implements Cloneable {
    ...
    public String toString() {
        StringBuilder m14987g = C0048o.m14987g("[maxObjectSize=");
        m14987g.append(this.maxObjectSize);
        m14987g.append(", maxCacheEntries=");
        m14987g.append(this.maxCacheEntries);
        m14987g.append(", maxUpdateRetries=");
        m14987g.append(this.maxUpdateRetries);
        m14987g.append(", 303CachingEnabled=");
        m14987g.append(this.allow303Caching);
        m14987g.append(", weakETagOnPutDeleteAllowed=");
        m14987g.append(this.weakETagOnPutDeleteAllowed);
        m14987g.append(", heuristicCachingEnabled=");
        m14987g.append(this.heuristicCachingEnabled);
        m14987g.append(", heuristicCoefficient=");
        m14987g.append(this.heuristicCoefficient);
        m14987g.append(", heuristicDefaultLifetime=");
        m14987g.append(this.heuristicDefaultLifetime);
        m14987g.append(", isSharedCache=");
        m14987g.append(this.isSharedCache);
        m14987g.append(", asynchronousWorkersMax=");
        m14987g.append(this.asynchronousWorkersMax);
        m14987g.append(", asynchronousWorkersCore=");
        m14987g.append(this.asynchronousWorkersCore);
        m14987g.append(", asynchronousWorkerIdleLifetimeSecs=");
        m14987g.append(this.asynchronousWorkerIdleLifetimeSecs);
        m14987g.append(", revalidationQueueSize=");
        m14987g.append(this.revalidationQueueSize);
        m14987g.append(", neverCacheHTTP10ResponsesWithQuery=");
        m14987g.append(this.neverCacheHTTP10ResponsesWithQuery);
        m14987g.append("]");
        return m14987g.toString();
    }

    /* renamed from: clone */
    public CacheConfig m15439clone() throws CloneNotSupportedException {

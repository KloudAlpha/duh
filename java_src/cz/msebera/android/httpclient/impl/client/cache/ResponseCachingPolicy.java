...
public class ResponseCachingPolicy {
    ...
    private static final Set<Integer> cacheableStatuses = new HashSet(Arrays.asList(200, Integer.valueOf((int) HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION), Integer.valueOf((int) HttpStatus.SC_MULTIPLE_CHOICES), Integer.valueOf((int) HttpStatus.SC_MOVED_PERMANENTLY), Integer.valueOf((int) HttpStatus.SC_GONE)));
    ...
    public ResponseCachingPolicy(long j, boolean z, boolean z2, boolean z3) {
        ...
        Integer valueOf = Integer.valueOf((int) HttpStatus.SC_PARTIAL_CONTENT);
        if (z3) {
            this.uncacheableStatuses = new HashSet(Arrays.asList(valueOf));
        } else {
            this.uncacheableStatuses = new HashSet(Arrays.asList(valueOf, Integer.valueOf((int) HttpStatus.SC_SEE_OTHER)));
        }
    }

            ...
            synchronized (this) {
                if (this.cookieSpec == null) {
                    ...
                    if (this.compatibilityLevel == CompatibilityLevel.IE_MEDIUM_SECURITY) {
                        basicPathHandler = new BasicPathHandler() { // from class: cz.msebera.android.httpclient.impl.cookie.DefaultCookieSpecProvider.1
                    ...
                    if (strArr2 != null) {
                        ...
                        strArr = new String[]{NetscapeDraftSpec.EXPIRES_PATTERN};
                    }
                    commonCookieAttributeHandlerArr[4] = new BasicExpiresHandler(strArr);

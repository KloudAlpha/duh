...
public class RFC6265CookieSpec implements CookieSpec {
    ...
    public final List<Cookie> parse(Header header, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        if (header.getName().equalsIgnoreCase(InterfaceC3148SM.SET_COOKIE)) {
            ...
            StringBuilder m14987g = C0048o.m14987g("Cookie value is invalid: '");
            m14987g.append(header.toString());
            m14987g.append("'");
            throw new MalformedCookieException(m14987g.toString());
        }
        StringBuilder m14987g2 = C0048o.m14987g("Unrecognized cookie header: '");
        m14987g2.append(header.toString());
        m14987g2.append("'");
        throw new MalformedCookieException(m14987g2.toString());
    }

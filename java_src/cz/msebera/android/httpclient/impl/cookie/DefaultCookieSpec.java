...
public class DefaultCookieSpec implements CookieSpec {
    ...
    public List<Cookie> parse(Header header, CookieOrigin cookieOrigin) throws MalformedCookieException {
        ...
        if (!z && z2) {
            if (InterfaceC3148SM.SET_COOKIE2.equals(header.getName())) {
    ...
    public DefaultCookieSpec(String[] strArr, boolean z) {
        ...
        commonCookieAttributeHandlerArr[4] = new BasicExpiresHandler(strArr != null ? (String[]) strArr.clone() : new String[]{NetscapeDraftSpec.EXPIRES_PATTERN});

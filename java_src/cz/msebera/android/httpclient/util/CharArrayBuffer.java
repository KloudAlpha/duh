    ...
    public CharSequence subSequence(int i, int i2) {
        if (i >= 0) {
            if (i2 <= this.len) {
                ...
                throw new IndexOutOfBoundsException(C0333l.m14475d("beginIndex: ", i, " > endIndex: ", i2));
            }
            StringBuilder m15002f = C0045n.m15002f("endIndex: ", i2, " > length: ");
            m15002f.append(this.len);
            throw new IndexOutOfBoundsException(m15002f.toString());
        }
        throw new IndexOutOfBoundsException(C0455a0.m14180c("Negative beginIndex: ", i));
    }

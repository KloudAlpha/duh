...
public final class C9601m1 extends AbstractC8595g.AbstractC8597b {
    public C9601m1(AbstractC8584d abstractC8584d, AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2) {
        super(abstractC8584d, abstractC8590f, abstractC8590f2);
    }

    public C9601m1(AbstractC8584d abstractC8584d, AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2, AbstractC8590f[] abstractC8590fArr) {
    ...
    public final AbstractC8595g mo3560a(AbstractC8595g abstractC8595g) {
        ...
        if (abstractC8590f8.mo3547i()) {
            ...
            abstractC8590f5 = mo3551d.mo3541o().mo3553a(mo3551d).mo3553a(abstractC8590f12).mo3552b();
            if (abstractC8590f5.mo3547i()) {
                return new C9601m1(abstractC8584d, abstractC8590f5, abstractC8584d.f20726c);
            }
            ...
            if (mo3546j3.mo3547i()) {
                return new C9601m1(abstractC8584d, mo3546j3, abstractC8584d.f20726c);
            }
        ...
        return new C9601m1(abstractC8584d, abstractC8590f5, mo3540p, new AbstractC8590f[]{abstractC8590f6});
    }
    ...
    public final AbstractC8595g mo3559c() {
        m4660b();
        return new C9601m1(null, this.f20755b, m4658e());
    }
    ...
    public final AbstractC8595g mo3556n() {
        ...
        AbstractC8590f abstractC8590f2 = this.f20756c;
        AbstractC8590f abstractC8590f3 = this.f20757d[0];
        return new C9601m1(this.f20754a, abstractC8590f, abstractC8590f2.mo3553a(abstractC8590f3), new AbstractC8590f[]{abstractC8590f3});
    }
    ...
    public final AbstractC8595g mo3555x() {
        ...
        if (mo3548h) {
            mo3546j = abstractC8590f2;
        } else {
            mo3546j = abstractC8590f2.mo3546j(abstractC8590f3);
        }
        if (!mo3548h) {
            abstractC8590f3 = abstractC8590f3.mo3541o();
        }
        AbstractC8590f m14998j = C0045n.m14998j(abstractC8590f2, mo3546j, abstractC8590f3);
        if (m14998j.mo3547i()) {
            return new C9601m1(abstractC8584d, m14998j, abstractC8584d.f20726c);
        }
        AbstractC8590f mo3541o = m14998j.mo3541o();
        if (mo3548h) {
            mo3546j2 = m14998j;
        } else {
            mo3546j2 = m14998j.mo3546j(abstractC8590f3);
        }
        AbstractC8590f mo3541o2 = abstractC8590f2.mo3553a(abstractC8590f).mo3541o();
        return new C9601m1(abstractC8584d, mo3541o, mo3541o2.mo3553a(m14998j).mo3553a(abstractC8590f3).mo3546j(mo3541o2).mo3553a(mo3541o), new AbstractC8590f[]{mo3546j2});
    }
    ...
    public final AbstractC8595g mo3554y(AbstractC8595g abstractC8595g) {
        ...
        if (!abstractC8590f2.mo3547i() && mo4139j.mo3548h()) {
            ...
            AbstractC8590f mo3553a = mo3541o3.mo3553a(mo3541o2).mo3553a(abstractC8590f3.mo3546j(abstractC8590f4));
            AbstractC8590f mo3544l = abstractC8590f5.mo3546j(mo3541o3).mo3553a(mo3541o2).mo3544l(mo3553a, mo3541o, mo3541o3);
            ...
            if (mo3541o4.mo3547i()) {
                ...
                return new C9601m1(abstractC8584d, mo3544l, abstractC8584d.f20726c);
            } else {
                AbstractC8590f mo3546j2 = mo3544l.mo3541o().mo3546j(mo3546j);
                AbstractC8590f mo3546j3 = mo3544l.mo3546j(mo3541o4).mo3546j(mo3541o3);
                return new C9601m1(abstractC8584d, mo3546j2, mo3544l.mo3553a(mo3541o4).mo3541o().mo3544l(mo3553a, abstractC8590f5.mo3552b(), mo3546j3), new AbstractC8590f[]{mo3546j3});
            }
        }

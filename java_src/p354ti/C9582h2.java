...
public final class C9582h2 extends AbstractC8590f.AbstractC8591a {

    /* renamed from: b */
    public long[] f23431b;

    public C9582h2() {
        this.f23431b = new long[4];
    }

    public C9582h2(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.bitLength() > 239) {
            throw new IllegalArgumentException("x value invalid for SecT239FieldElement");
        }
        this.f23431b = AbstractC0219d.m14826A1(239, bigInteger);
    }

    public C9582h2(long[] jArr) {
        this.f23431b = jArr;
    }
    ...
    public final AbstractC8590f mo3553a(AbstractC8590f abstractC8590f) {
        long[] jArr = this.f23431b;
        long[] jArr2 = ((C9582h2) abstractC8590f).f23431b;
        return new C9582h2(new long[]{jArr[0] ^ jArr2[0], jArr[1] ^ jArr2[1], jArr[2] ^ jArr2[2], jArr[3] ^ jArr2[3]});
    }
    ...
    public final AbstractC8590f mo3552b() {
        long[] jArr = this.f23431b;
        return new C9582h2(new long[]{jArr[0] ^ 1, jArr[1], jArr[2], jArr[3]});
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C9582h2) {
            return AbstractC0219d.m14662u1(this.f23431b, ((C9582h2) obj).f23431b);
        }
        return false;
    }
    ...
    public final AbstractC8590f mo3549g() {
        ...
        long[] jArr2 = this.f23431b;
        if (!AbstractC0219d.m14645y2(jArr2)) {
            long[] jArr3 = new long[4];
            long[] jArr4 = new long[4];
            C0654j0.m13816F1(jArr2, jArr3);
            C0654j0.m13712p1(jArr3, jArr2, jArr3);
            C0654j0.m13816F1(jArr3, jArr3);
            C0654j0.m13712p1(jArr3, jArr2, jArr3);
            C0654j0.m13801K1(jArr3, 3, jArr4);
            C0654j0.m13712p1(jArr4, jArr3, jArr4);
            C0654j0.m13816F1(jArr4, jArr4);
            C0654j0.m13712p1(jArr4, jArr2, jArr4);
            C0654j0.m13801K1(jArr4, 7, jArr3);
            C0654j0.m13712p1(jArr3, jArr4, jArr3);
            C0654j0.m13801K1(jArr3, 14, jArr4);
            C0654j0.m13712p1(jArr4, jArr3, jArr4);
            C0654j0.m13816F1(jArr4, jArr4);
            C0654j0.m13712p1(jArr4, jArr2, jArr4);
            C0654j0.m13801K1(jArr4, 29, jArr3);
            C0654j0.m13712p1(jArr3, jArr4, jArr3);
            C0654j0.m13816F1(jArr3, jArr3);
            C0654j0.m13712p1(jArr3, jArr2, jArr3);
            C0654j0.m13801K1(jArr3, 59, jArr4);
            C0654j0.m13712p1(jArr4, jArr3, jArr4);
            C0654j0.m13816F1(jArr4, jArr4);
            C0654j0.m13712p1(jArr4, jArr2, jArr4);
            C0654j0.m13801K1(jArr4, 119, jArr3);
            C0654j0.m13712p1(jArr3, jArr4, jArr3);
            C0654j0.m13816F1(jArr3, jArr);
            return new C9582h2(jArr);
        }
    ...
    public final boolean mo3548h() {
        return AbstractC0219d.m14684n2(this.f23431b);
    }

    public final int hashCode() {
        return C9001a.m4124n(4, this.f23431b) ^ 23900158;
    }

    @Override // p306qi.AbstractC8590f
    /* renamed from: i */
    public final boolean mo3547i() {
        return AbstractC0219d.m14645y2(this.f23431b);
    }
    ...
    public final AbstractC8590f mo3546j(AbstractC8590f abstractC8590f) {
        long[] jArr = new long[4];
        C0654j0.m13712p1(this.f23431b, ((C9582h2) abstractC8590f).f23431b, jArr);
        return new C9582h2(jArr);
    }
    ...
    public final AbstractC8590f mo3544l(AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2, AbstractC8590f abstractC8590f3) {
        long[] jArr = this.f23431b;
        long[] jArr2 = ((C9582h2) abstractC8590f).f23431b;
        long[] jArr3 = ((C9582h2) abstractC8590f2).f23431b;
        long[] jArr4 = ((C9582h2) abstractC8590f3).f23431b;
        long[] jArr5 = new long[8];
        long[] jArr6 = new long[8];
        C0654j0.m13769V0(jArr, jArr2, jArr6);
        C0654j0.m13797M(jArr5, jArr6, jArr5);
        long[] jArr7 = new long[8];
        C0654j0.m13769V0(jArr3, jArr4, jArr7);
        C0654j0.m13797M(jArr5, jArr7, jArr5);
        long[] jArr8 = new long[4];
        C0654j0.m13688x1(jArr5, jArr8);
        return new C9582h2(jArr8);
    }
    ...
    public final AbstractC8590f mo3542n() {
        ...
        long j4 = (m13765W14 & (-4294967296L)) | (m13765W13 >>> 32);
        long j5 = j4 >>> 49;
        long j6 = (j2 >>> 49) | (j4 << 15);
        long j7 = j4 ^ (j2 << 15);
    ...
    public final AbstractC8590f mo3541o() {
        long[] jArr = new long[4];
        C0654j0.m13816F1(this.f23431b, jArr);
        return new C9582h2(jArr);
    }
    ...
    public final AbstractC8590f mo3540p(AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2) {
        ...
        C0654j0.m13797M(jArr4, jArr5, jArr4);
        long[] jArr6 = new long[8];
        C0654j0.m13769V0(jArr2, jArr3, jArr6);
        C0654j0.m13797M(jArr4, jArr6, jArr4);
        long[] jArr7 = new long[4];
        C0654j0.m13688x1(jArr4, jArr7);
        return new C9582h2(jArr7);
    }
    ...
    public final AbstractC8590f mo3539q(int i) {
        ...
        long[] jArr = new long[4];
        C0654j0.m13801K1(this.f23431b, i, jArr);
        return new C9582h2(jArr);
    }
    ...
    public final boolean mo3537s() {
        return (this.f23431b[0] & 1) != 0;
    }

    @Override // p306qi.AbstractC8590f
    /* renamed from: t */
    public final BigInteger mo3536t() {
        return AbstractC0219d.m14729b4(this.f23431b);
    }

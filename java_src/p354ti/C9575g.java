...
public final class C9575g extends AbstractC8595g.AbstractC8598c {
    public C9575g(AbstractC8584d abstractC8584d, AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2) {
        super(abstractC8584d, abstractC8590f, abstractC8590f2);
    }

    public C9575g(AbstractC8584d abstractC8584d, AbstractC8590f abstractC8590f, AbstractC8590f abstractC8590f2, AbstractC8590f[] abstractC8590fArr) {
    ...
    public final AbstractC8595g mo3560a(AbstractC8595g abstractC8595g) {
        ...
        return new C9575g(abstractC8584d, c9603n7, c9603n8, new AbstractC8590f[]{c9603n9});
    }
    ...
    public final AbstractC8595g mo3559c() {
        m4660b();
        return new C9575g(null, this.f20755b, m4658e());
    }

    @Override // p306qi.AbstractC8595g
    /* renamed from: n */
    public final AbstractC8595g mo3556n() {
        return m4654l() ? this : new C9575g(this.f20754a, this.f20755b, this.f20756c.mo3543m(), this.f20757d);
    }
    ...
    public final AbstractC8595g mo3555x() {
        ...
        int[] iArr = new int[5];
        C0770z.m13542I0(c9603n.f23467b, iArr);
        int[] iArr2 = new int[5];
        C0770z.m13542I0(iArr, iArr2);
        int[] iArr3 = new int[5];
        C0770z.m13542I0(c9603n2.f23467b, iArr3);
        C0770z.m13463x0(AbstractC0219d.m14715f0(iArr3, iArr3, iArr3), iArr3);
        C0770z.m13485m0(iArr, c9603n2.f23467b, iArr);
        C0770z.m13463x0(AbstractC0219d.m14671r3(5, iArr), iArr);
        int[] iArr4 = new int[5];
        C0770z.m13463x0(AbstractC0219d.m14668s3(5, iArr2, iArr4), iArr4);
        C9603n c9603n4 = new C9603n(iArr2);
        C0770z.m13542I0(iArr3, iArr2);
        int[] iArr5 = c9603n4.f23467b;
        C0770z.m13526Q0(iArr5, iArr, iArr5);
        int[] iArr6 = c9603n4.f23467b;
        C0770z.m13526Q0(iArr6, iArr, iArr6);
        C9603n c9603n5 = new C9603n(iArr);
        C0770z.m13526Q0(iArr, c9603n4.f23467b, iArr);
        int[] iArr7 = c9603n5.f23467b;
        C0770z.m13485m0(iArr7, iArr3, iArr7);
        int[] iArr8 = c9603n5.f23467b;
        C0770z.m13526Q0(iArr8, iArr4, iArr8);
        C9603n c9603n6 = new C9603n(iArr3);
        if (AbstractC0219d.m14675q3(5, 0, c9603n.f23467b, iArr3) != 0 || (iArr3[4] == -1 && AbstractC0219d.m14771T1(iArr3, C0770z.f2413a1))) {
            AbstractC0219d.m14728c0(5, 21389, iArr3);
        }
        if (!c9603n3.mo3548h()) {
            int[] iArr9 = c9603n6.f23467b;
            C0770z.m13485m0(iArr9, c9603n3.f23467b, iArr9);
        }
        return new C9575g(abstractC8584d, c9603n4, c9603n5, new AbstractC8590f[]{c9603n6});
    }

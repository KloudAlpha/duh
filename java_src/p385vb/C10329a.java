...
public final class C10329a {
    ...
    /* renamed from: a */
    public static final TimeZone f25257a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    public static boolean m3039a(String str, int i, char c) {
    ...
    */
    public static Date m3038b(String str, ParsePosition parsePosition) throws ParseException {
        String str2;
        int i;
        int i2;
        int i3;
        ...
        try {
            ...
            int i7 = index + 4;
            int m3037c = m3037c(str, index, i7);
            if (m3039a(str, i7, '-')) {
                i7++;
            }
            int i8 = i7 + 2;
            int m3037c2 = m3037c(str, i7, i8);
            if (m3039a(str, i8, '-')) {
                i8++;
            }
            int i9 = i8 + 2;
            int m3037c3 = m3037c(str, i8, i9);
            boolean m3039a = m3039a(str, i9, 'T');
            if (!m3039a && str.length() <= i9) {
                GregorianCalendar gregorianCalendar = new GregorianCalendar(m3037c, m3037c2 - 1, m3037c3);
            ...
            if (m3039a) {
                int i10 = i9 + 1;
                int i11 = i10 + 2;
                i5 = m3037c(str, i10, i11);
                if (m3039a(str, i11, ':')) {
                    i11++;
                }
                int i12 = i11 + 2;
                i2 = m3037c(str, i11, i12);
                if (m3039a(str, i12, ':')) {
                    i12++;
                }
                if (str.length() > i12 && (charAt = str.charAt(i12)) != 'Z' && charAt != '+' && charAt != '-') {
                    i6 = i12 + 2;
                    i4 = m3037c(str, i12, i6);
                    if (i4 > 59 && i4 < 63) {
                        i4 = 59;
                    }
                    if (m3039a(str, i6, '.')) {
                    ...
                    if (str.length() <= i6) {
                        ...
                        gregorianCalendar2.set(1, m3037c);
                        gregorianCalendar2.set(2, m3037c2 - 1);
                        gregorianCalendar2.set(5, m3037c3);
    ...
    /* renamed from: c */
    public static int m3037c(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
        if (i >= 0 && i2 <= str.length() && i <= i2) {
            if (i < i2) {
                ...
                if (digit >= 0) {
                    ...
                    StringBuilder m14987g = C0048o.m14987g("Invalid number: ");
                    m14987g.append(str.substring(i, i2));
            ...
            while (i4 < i2) {
                ...
                if (digit2 >= 0) {
                    ...
                    StringBuilder m14987g2 = C0048o.m14987g("Invalid number: ");
                    m14987g2.append(str.substring(i, i2));

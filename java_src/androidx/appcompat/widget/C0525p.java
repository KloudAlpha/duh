...
public class C0525p extends ImageButton {

    /* renamed from: b */
    public final C0484f f1771b;

    /* renamed from: c */
    public final C0528q f1772c;

    /* renamed from: d */
    public boolean f1773d;

    public C0525p(Context context, AttributeSet attributeSet) {
    ...
    public final void drawableStateChanged() {
        ...
        C0484f c0484f = this.f1771b;
        if (c0484f != null) {
            c0484f.m14101a();
        }
        C0528q c0528q = this.f1772c;
        if (c0528q != null) {
            c0528q.m13954a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(this.f1772c.f1790a.getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C0528q c0528q = this.f1772c;
        if (c0528q != null && drawable != null && !this.f1773d) {
            c0528q.f1792c = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        C0528q c0528q2 = this.f1772c;
        if (c0528q2 != null) {
            c0528q2.m13954a();
            if (!this.f1773d) {
                C0528q c0528q3 = this.f1772c;
    ...
    public C0525p(Context context, AttributeSet attributeSet, int i) {

...
public final class C6387w extends AbstractC3336l implements InterfaceC1913q<InterfaceC6266d<?>, C6360p2, InterfaceC6323i2, C9473u> {

    /* renamed from: b */
    public final /* synthetic */ C3348x f15703b;

    /* renamed from: c */
    public final /* synthetic */ List<InterfaceC1913q<InterfaceC6266d<?>, C6360p2, InterfaceC6323i2, C9473u>> f15704c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C6387w(C3348x c3348x, ArrayList arrayList) {
        super(3);
        this.f15703b = c3348x;
    ...
    public final C9473u invoke(InterfaceC6266d<?> interfaceC6266d, C6360p2 c6360p2, InterfaceC6323i2 interfaceC6323i2) {
        ...
        int i = this.f15703b.f7404b;
        if (i > 0) {
            interfaceC6266d2 = new C6336l1(interfaceC6266d2, i);
        }
        List<InterfaceC1913q<InterfaceC6266d<?>, C6360p2, InterfaceC6323i2, C9473u>> list = this.f15704c;
        int size = list.size();

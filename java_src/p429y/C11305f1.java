...
public final class C11305f1 extends AbstractC3336l implements InterfaceC1908l<C0698p1, C9473u> {

    /* renamed from: b */
    public final /* synthetic */ float f27719b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11305f1(float f) {
        super(1);
        this.f27719b = f;
    }
    ...
    public final C9473u invoke(C0698p1 c0698p1) {
        ...
        c0698p12.f2235a.m13677a(Float.valueOf(this.f27719b), "fraction");

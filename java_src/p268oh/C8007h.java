...
public final class C8007h implements InterfaceC5616d {
    ...
    /* renamed from: d */
    public int[] f19258d = new int[96];

    /* renamed from: q */
    public int[] f19259q = new int[8];

    /* renamed from: x */
    public int[] f19260x = new int[12];

    /* renamed from: y */
    public int[] f19261y = new int[4];

    /* renamed from: a */
    public static int m5752a(int i, byte[] bArr) {
        int i2 = 0;
    ...
    /* renamed from: b */
    public static void m5751b(int i, int[] iArr, int[] iArr2) {
        int i2 = iArr[0];
        int i3 = iArr2[i + 0] ^ i2;
        int[] iArr3 = f19253Z;
        int i4 = iArr3[i3 & 255];
        int[] iArr4 = f19255v1;
        int i5 = i4 ^ iArr4[(i3 >>> 8) & 255];
        int[] iArr5 = f19254a1;
        int i6 = i5 ^ iArr5[(i3 >>> 16) & 255];
        int[] iArr6 = f19252Y;
        int i7 = iArr6[(i3 >>> 24) & 255] ^ i6;
        int i8 = iArr[1];
        int i9 = iArr2[i + 1] ^ i8;
        int i10 = (iArr5[(i9 >>> 24) & 255] ^ ((iArr6[i9 & 255] ^ iArr3[(i9 >>> 8) & 255]) ^ iArr4[(i9 >>> 16) & 255])) ^ i7;
        int i11 = iArr[2] ^ i10;
        iArr[2] = i11;
        int i12 = (((i7 >>> 8) + (i7 << 24)) ^ i10) ^ iArr[3];
        iArr[3] = i12;
        int i13 = iArr2[i + 2] ^ i11;
        int i14 = iArr6[(i13 >>> 24) & 255] ^ ((iArr3[i13 & 255] ^ iArr4[(i13 >>> 8) & 255]) ^ iArr5[(i13 >>> 16) & 255]);
        int i15 = i12 ^ iArr2[3 + i];
        int i16 = iArr6[i15 & 255];
        int i17 = (iArr5[(i15 >>> 24) & 255] ^ ((iArr3[(i15 >>> 8) & 255] ^ i16) ^ iArr4[(i15 >>> 16) & 255])) ^ i14;
        iArr[0] = i2 ^ i17;
        iArr[1] = (((i14 >>> 8) + (i14 << 24)) ^ i17) ^ i8;
    }

    /* renamed from: c */
    public static void m5750c(int i, int[] iArr, int[] iArr2) {
        int i2 = iArr[1];
        int i3 = iArr[0];
        int i4 = iArr2[i + 0] & i3;
    ...
    /* renamed from: e */
    public static void m5749e(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: g */
    public static void m5748g(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    /* renamed from: h */
    public static void m5747h(byte[] bArr, int i, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            bArr[(3 - i3) + i2] = (byte) i;
            i >>>= 8;
        }
    ...
    /* renamed from: i */
    public static void m5746i(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    /* renamed from: j */
    public static void m5745j(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
        ...
        if (this.f19256b) {
            if (i + 16 <= bArr.length) {
                if (i2 + 16 <= bArr2.length) {
                    if (this.f19257c) {
                        for (int i3 = 0; i3 < 4; i3++) {
                            this.f19261y[i3] = m5752a((i3 * 4) + i, bArr);
                            int[] iArr = this.f19261y;
                            iArr[i3] = iArr[i3] ^ this.f19259q[i3];
                        }
                        m5751b(0, this.f19261y, this.f19258d);
                        m5751b(4, this.f19261y, this.f19258d);
                        m5751b(8, this.f19261y, this.f19258d);
                        m5750c(0, this.f19261y, this.f19260x);
                        m5751b(12, this.f19261y, this.f19258d);
                        m5751b(16, this.f19261y, this.f19258d);
                        m5751b(20, this.f19261y, this.f19258d);
                        m5750c(4, this.f19261y, this.f19260x);
                        m5751b(24, this.f19261y, this.f19258d);
                        m5751b(28, this.f19261y, this.f19258d);
                        m5751b(32, this.f19261y, this.f19258d);
                        int[] iArr2 = this.f19261y;
                        int i4 = iArr2[2];
                        int[] iArr3 = this.f19259q;
                        int i5 = i4 ^ iArr3[4];
                        iArr2[2] = i5;
                        ...
                        m5747h(bArr2, i5, i2);
                        m5747h(bArr2, this.f19261y[3], i2 + 4);
                        m5747h(bArr2, this.f19261y[0], i2 + 8);
                        m5747h(bArr2, this.f19261y[1], i2 + 12);
                        return 16;
                    }
                    for (int i6 = 0; i6 < 4; i6++) {
                        this.f19261y[i6] = m5752a((i6 * 4) + i, bArr);
                        int[] iArr4 = this.f19261y;
                        iArr4[i6] = iArr4[i6] ^ this.f19259q[i6];
                    }
                    m5751b(0, this.f19261y, this.f19258d);
                    m5751b(4, this.f19261y, this.f19258d);
                    m5751b(8, this.f19261y, this.f19258d);
                    ...
                    m5751b(28, this.f19261y, this.f19258d);
                    m5751b(32, this.f19261y, this.f19258d);
                    m5750c(8, this.f19261y, this.f19260x);
                    m5751b(36, this.f19261y, this.f19258d);
                    m5751b(40, this.f19261y, this.f19258d);
                    m5751b(44, this.f19261y, this.f19258d);
                    int[] iArr5 = this.f19261y;
                    int i7 = iArr5[2];
                    int[] iArr6 = this.f19259q;
                    int i8 = i7 ^ iArr6[4];
                    iArr5[2] = i8;
                    iArr5[3] = iArr5[3] ^ iArr6[5];
                    iArr5[0] = iArr5[0] ^ iArr6[6];
                    iArr5[1] = iArr6[7] ^ iArr5[1];
                    m5747h(bArr2, i8, i2);
                    m5747h(bArr2, this.f19261y[3], i2 + 4);
                    m5747h(bArr2, this.f19261y[0], i2 + 8);
                    m5747h(bArr2, this.f19261y[1], i2 + 12);
    ...
    public final void init(boolean z, InterfaceC5622h interfaceC5622h) throws IllegalArgumentException {
        if (interfaceC5622h instanceof C10774v0) {
            ...
            if (length != 16) {
                if (length != 24) {
                    if (length == 32) {
                        iArr[0] = m5752a(0, bArr);
                        iArr[1] = m5752a(4, bArr);
                        iArr[2] = m5752a(8, bArr);
                        iArr[3] = m5752a(12, bArr);
                        iArr[4] = m5752a(16, bArr);
                        iArr[5] = m5752a(20, bArr);
                        iArr[6] = m5752a(24, bArr);
                        iArr[7] = m5752a(28, bArr);
                    } else {
            ...
            m5751b(0, iArr2, f19251X);
            for (int i2 = 0; i2 < 4; i2++) {
                iArr2[i2] = iArr2[i2] ^ iArr[i2];
            }
            m5751b(4, iArr2, f19251X);
            if (this.f19257c) {
                int[] iArr5 = this.f19259q;
                if (z) {
                    iArr5[0] = iArr[0];
                    iArr5[1] = iArr[1];
                    iArr5[2] = iArr[2];
                    iArr5[3] = iArr[3];
                    m5746i(15, 0, iArr, this.f19258d, 4);
                    m5746i(30, 0, iArr, this.f19258d, 12);
                    m5746i(15, 0, iArr, iArr4, 0);
                    int[] iArr6 = this.f19258d;
                    iArr6[18] = iArr4[2];
                    iArr6[19] = iArr4[3];
                    m5746i(17, 0, iArr, this.f19260x, 4);
                    m5746i(17, 0, iArr, this.f19258d, 24);
                    m5746i(17, 0, iArr, this.f19258d, 32);
                    int[] iArr7 = this.f19258d;
                    iArr7[0] = iArr2[0];
                    iArr7[1] = iArr2[1];
                    iArr7[2] = iArr2[2];
                    iArr7[3] = iArr2[3];
                    m5746i(15, 0, iArr2, iArr7, 8);
                    m5746i(15, 0, iArr2, this.f19260x, 0);
                    m5746i(15, 0, iArr2, iArr4, 0);
                    int[] iArr8 = this.f19258d;
                    iArr8[16] = iArr4[0];
                    iArr8[17] = iArr4[1];
                    m5746i(15, 0, iArr2, iArr8, 20);
                    m5745j(34, 0, iArr2, this.f19258d, 28);
                    m5746i(17, 0, iArr2, this.f19259q, 4);
                } else {
                    iArr5[4] = iArr[0];
                    iArr5[5] = iArr[1];
                    iArr5[6] = iArr[2];
                    iArr5[7] = iArr[3];
                    m5749e(15, 0, iArr, this.f19258d, 28);
                    m5749e(30, 0, iArr, this.f19258d, 20);
                    m5749e(15, 0, iArr, iArr4, 0);
                    int[] iArr9 = this.f19258d;
                    iArr9[16] = iArr4[0];
                    iArr9[17] = iArr4[1];
                    m5749e(17, 0, iArr, this.f19260x, 0);
                    m5749e(17, 0, iArr, this.f19258d, 8);
                    m5749e(17, 0, iArr, this.f19258d, 0);
                    int[] iArr10 = this.f19258d;
                    iArr10[34] = iArr2[0];
                    iArr10[35] = iArr2[1];
                    iArr10[32] = iArr2[2];
                    iArr10[33] = iArr2[3];
                    m5749e(15, 0, iArr2, iArr10, 24);
                    m5749e(15, 0, iArr2, this.f19260x, 4);
                    m5749e(15, 0, iArr2, iArr4, 0);
                    int[] iArr11 = this.f19258d;
                    iArr11[18] = iArr4[2];
                    iArr11[19] = iArr4[3];
                    m5749e(15, 0, iArr2, iArr11, 12);
                    m5748g(34, 0, iArr2, this.f19258d, 4);
                    m5746i(17, 0, iArr2, this.f19259q, 0);
                }
            } else {
                for (int i3 = 0; i3 < 4; i3++) {
                    iArr3[i3] = iArr2[i3] ^ iArr[i3 + 4];
                }
                m5751b(8, iArr3, f19251X);
                int[] iArr12 = this.f19259q;
                if (z) {
                    iArr12[0] = iArr[0];
                    iArr12[1] = iArr[1];
                    iArr12[2] = iArr[2];
                    iArr12[3] = iArr[3];
                    m5745j(45, 0, iArr, this.f19258d, 16);
                    m5746i(15, 0, iArr, this.f19260x, 4);
                    m5746i(17, 0, iArr, this.f19258d, 32);
                    m5745j(34, 0, iArr, this.f19258d, 44);
                    m5746i(15, 4, iArr, this.f19258d, 4);
                    m5746i(15, 4, iArr, this.f19260x, 0);
                    m5746i(30, 4, iArr, this.f19258d, 24);
                    m5745j(34, 4, iArr, this.f19258d, 36);
                    m5746i(15, 0, iArr2, this.f19258d, 8);
                    m5746i(30, 0, iArr2, this.f19258d, 20);
                    int[] iArr13 = this.f19260x;
                    iArr13[8] = iArr2[1];
                    iArr13[9] = iArr2[2];
                    iArr13[10] = iArr2[3];
                    iArr13[11] = iArr2[0];
                    m5745j(49, 0, iArr2, this.f19258d, 40);
                    int[] iArr14 = this.f19258d;
                    iArr14[0] = iArr3[0];
                    iArr14[1] = iArr3[1];
                    iArr14[2] = iArr3[2];
                    iArr14[3] = iArr3[3];
                    m5746i(30, 0, iArr3, iArr14, 12);
                    m5746i(30, 0, iArr3, this.f19258d, 28);
                    m5745j(51, 0, iArr3, this.f19259q, 4);
                } else {
                    iArr12[4] = iArr[0];
                    iArr12[5] = iArr[1];
                    iArr12[6] = iArr[2];
                    iArr12[7] = iArr[3];
                    m5748g(45, 0, iArr, this.f19258d, 28);
                    m5749e(15, 0, iArr, this.f19260x, 4);
                    m5749e(17, 0, iArr, this.f19258d, 12);
                    m5748g(34, 0, iArr, this.f19258d, 0);
                    m5749e(15, 4, iArr, this.f19258d, 40);
                    m5749e(15, 4, iArr, this.f19260x, 8);
                    m5749e(30, 4, iArr, this.f19258d, 20);
                    m5748g(34, 4, iArr, this.f19258d, 8);
                    m5749e(15, 0, iArr2, this.f19258d, 36);
                    m5749e(30, 0, iArr2, this.f19258d, 24);
                    int[] iArr15 = this.f19260x;
                    iArr15[2] = iArr2[1];
                    iArr15[3] = iArr2[2];
                    iArr15[0] = iArr2[3];
                    iArr15[1] = iArr2[0];
                    m5748g(49, 0, iArr2, this.f19258d, 4);
                    int[] iArr16 = this.f19258d;
                    iArr16[46] = iArr3[0];
                    iArr16[47] = iArr3[1];
                    iArr16[44] = iArr3[2];
                    iArr16[45] = iArr3[3];
                    m5749e(30, 0, iArr3, iArr16, 32);
                    m5749e(30, 0, iArr3, this.f19258d, 16);
                    m5745j(51, 0, iArr3, this.f19259q, 0);
                }
            }
            this.f19256b = true;
            return;

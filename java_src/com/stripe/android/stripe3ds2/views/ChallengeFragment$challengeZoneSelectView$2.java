...
public final class ChallengeFragment$challengeZoneSelectView$2 extends AbstractC3336l implements InterfaceC1897a<ChallengeZoneSelectView> {
        ...
        if (challengeResponseData != null) {
            if (challengeResponseData.getUiType() != UiType.SingleSelect) {
                ...
                if (challengeResponseData3 == null) {
                    ...
                    throw null;
                } else if (challengeResponseData3.getUiType() != UiType.MultiSelect) {
                    return null;
                }
            }
            ...
            if (challengeResponseData2 != null) {
                ...
                return challengeEntryViewFactory.createChallengeEntrySelectView(challengeResponseData2, stripeUiCustomization);
            }
            C3335k.m11444l("cresData");
            throw null;
        }

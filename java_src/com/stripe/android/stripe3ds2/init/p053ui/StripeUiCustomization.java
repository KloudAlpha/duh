...
public final class StripeUiCustomization implements UiCustomization, Parcelable {
    ...
    public static StripeUiCustomization createWithAppTheme(Activity activity2) {
        return new StripeUiCustomization(activity2);
    }
    ...
    private Context getThemeContext(Activity activity2, int i) {
        TypedValue typedValue = new TypedValue();
        if (activity2.getTheme().resolveAttribute(i, typedValue, true)) {
            return new C6236c(activity2, typedValue.resourceId);
        }
        return activity2;
    }
    ...
    @Override // com.stripe.android.stripe3ds2.init.p053ui.UiCustomization
    ...
    private StripeUiCustomization(Activity activity2) {
        this();
        Context themeContext = getThemeContext(activity2, R.attr.actionBarTheme);
        String themeColor = getThemeColor(activity2, 16843827);
        String themeColor2 = getThemeColor(activity2, 16843828);
        String themeColor3 = getThemeColor(themeContext, 16842806);
        String themeColor4 = getThemeColor(activity2, 16842904);
        String themeColor5 = getThemeColor(activity2, 16843829);
        String themeColor6 = getThemeColor(activity2, 16842906);

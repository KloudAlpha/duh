...
public final class StripeButtonCustomization extends BaseCustomization implements ButtonCustomization {
    ...
    private boolean typedEquals(StripeButtonCustomization stripeButtonCustomization) {
        if (ObjectUtils.equals(this.mBackgroundColor, stripeButtonCustomization.mBackgroundColor) && this.mCornerRadius == stripeButtonCustomization.mCornerRadius) {
            return true;
        }
        return false;
    }
    ...
    @Override // com.stripe.android.stripe3ds2.init.p053ui.ButtonCustomization

...
public final class USBankAccountFormFragment$NameAndEmailCollectionScreen$2 extends AbstractC3336l implements InterfaceC1912p<InterfaceC6296h, Integer, C9473u> {
    ...
    public final void invoke(InterfaceC6296h interfaceC6296h, int i) {
        this.$tmp0_rcvr.NameAndEmailCollectionScreen(this.$screenState, interfaceC6296h, this.$$changed | 1);
    }
}

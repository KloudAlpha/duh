...
public final class FinancialConnectionsSheetViewModel$onFatal$1 extends AbstractC3336l implements InterfaceC1908l<FinancialConnectionsSheetState, FinancialConnectionsSheetState> {
    public final /* synthetic */ FinancialConnectionsSheetActivityResult.Failed $result;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FinancialConnectionsSheetViewModel$onFatal$1(FinancialConnectionsSheetActivityResult.Failed failed) {
        super(1);
        this.$result = failed;
    }

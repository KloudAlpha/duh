...
public final class TextUpdate$$serializer implements InterfaceC1500j0<TextUpdate> {
    ...
    static {
        ...
        C1505k1 c1505k1 = new C1505k1("com.stripe.android.financialconnections.model.TextUpdate", textUpdate$$serializer, 1);
        c1505k1.m12498k("consent_pane", true);
        descriptor = c1505k1;
        $stable = 8;
    }
    ...
    public InterfaceC11868b<?>[] childSerializers() {
        return new InterfaceC11868b[]{C0770z.m13511Y(ConsentPane$$serializer.INSTANCE)};
    }

    @Override // p442yf.InterfaceC11867a
    public TextUpdate deserialize(InterfaceC0274d interfaceC0274d) {
        ...
        while (z) {
            ...
            if (mo11312L == -1) {
                ...
                obj = mo11316b.mo12466v(descriptor2, 0, ConsentPane$$serializer.INSTANCE, obj);
                i |= 1;
            }
        }
        mo11316b.mo11307d(descriptor2);
        return new TextUpdate(i, (ConsentPane) obj, (C1539s1) null);
    }
    ...
    public void serialize(InterfaceC0275e interfaceC0275e, TextUpdate textUpdate) {
        C3335k.m11451e(interfaceC0275e, "encoder");
        C3335k.m11451e(textUpdate, "value");
        InterfaceC12338e descriptor2 = getDescriptor();
        InterfaceC0273c mo11371b = interfaceC0275e.mo11371b(descriptor2);
        TextUpdate.write$Self(textUpdate, mo11371b, descriptor2);

...
/* renamed from: com.stripe.android.financialconnections.features.accountpicker.AccountPickerScreenKt$MultiSelectContent$1$invoke$$inlined$items$default$4 */
/* loaded from: classes.dex */
public final class C2287x3df1a43d extends AbstractC3336l implements InterfaceC1914r<InterfaceC11945f, Integer, InterfaceC6296h, Integer, C9473u> {
    ...
    public C2287x3df1a43d(List list, Set set, InterfaceC1908l interfaceC1908l, int i) {
        super(4);
        this.$items = list;
    ...
    public final void invoke(InterfaceC11945f interfaceC11945f, int i, InterfaceC6296h interfaceC6296h, int i2) {
        ...
        AccountPickerScreenKt.AccountItem(this.$selectedIds$inlined.contains(partnerAccountUI.getAccount().getId()), this.$onAccountClicked$inlined, partnerAccountUI, C0654j0.m13759Z(interfaceC6296h, 1340966562, new AccountPickerScreenKt$MultiSelectContent$1$3$1(this.$selectedIds$inlined, partnerAccountUI)), interfaceC6296h, ((this.$$dirty$inlined >> 3) & 112) | 3584);
    }
}

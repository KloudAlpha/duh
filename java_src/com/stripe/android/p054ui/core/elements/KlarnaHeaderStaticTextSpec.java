...
@InterfaceC11875i
/* renamed from: com.stripe.android.ui.core.elements.KlarnaHeaderStaticTextSpec */
...
public final class KlarnaHeaderStaticTextSpec extends FormItemSpec {
    ...
    /* compiled from: KlarnaHeaderStaticTextSpec.kt */
    /* renamed from: com.stripe.android.ui.core.elements.KlarnaHeaderStaticTextSpec$Companion */
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final InterfaceC11868b<KlarnaHeaderStaticTextSpec> serializer() {
    ...
    public /* synthetic */ KlarnaHeaderStaticTextSpec(int i, @InterfaceC11874h("api_path") IdentifierSpec identifierSpec, C1539s1 c1539s1) {
        super(null);
        if ((i & 0) != 0) {
            C0654j0.m13792N1(i, 0, KlarnaHeaderStaticTextSpec$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        if ((i & 1) == 0) {
    ...
    public static final void write$Self(KlarnaHeaderStaticTextSpec klarnaHeaderStaticTextSpec, InterfaceC0273c interfaceC0273c, InterfaceC12338e interfaceC12338e) {
        boolean z;
        C3335k.m11451e(klarnaHeaderStaticTextSpec, "self");
        C3335k.m11451e(interfaceC0273c, "output");
        C3335k.m11451e(interfaceC12338e, "serialDesc");
        if (interfaceC0273c.mo11361w(interfaceC12338e) || !C3335k.m11455a(klarnaHeaderStaticTextSpec.getApiPath(), IdentifierSpec.Companion.Generic("klarna_header_text"))) {
            z = true;
        } else {
            z = false;
        }
        if (z) {
            interfaceC0273c.mo12510i(interfaceC12338e, 0, IdentifierSpec$$serializer.INSTANCE, klarnaHeaderStaticTextSpec.getApiPath());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof KlarnaHeaderStaticTextSpec) && C3335k.m11455a(getApiPath(), ((KlarnaHeaderStaticTextSpec) obj).getApiPath());
    }
    ...
    public String toString() {
        StringBuilder m14987g = C0048o.m14987g("KlarnaHeaderStaticTextSpec(apiPath=");
    ...
    public /* synthetic */ KlarnaHeaderStaticTextSpec(IdentifierSpec identifierSpec, int i, C3330f c3330f) {

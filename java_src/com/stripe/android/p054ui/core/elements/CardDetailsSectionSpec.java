...
public final class CardDetailsSectionSpec extends FormItemSpec {
    ...
    public static final class Companion {
        ...
        public final InterfaceC11868b<CardDetailsSectionSpec> serializer() {
    ...
    public /* synthetic */ CardDetailsSectionSpec(int i, @InterfaceC11874h("api_path") IdentifierSpec identifierSpec, C1539s1 c1539s1) {
        super(null);
        if ((i & 0) != 0) {
            C0654j0.m13792N1(i, 0, CardDetailsSectionSpec$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        if ((i & 1) == 0) {
    ...
    public static final void write$Self(CardDetailsSectionSpec cardDetailsSectionSpec, InterfaceC0273c interfaceC0273c, InterfaceC12338e interfaceC12338e) {
        boolean z;
        C3335k.m11451e(cardDetailsSectionSpec, "self");
        C3335k.m11451e(interfaceC0273c, "output");
        C3335k.m11451e(interfaceC12338e, "serialDesc");
        if (interfaceC0273c.mo11361w(interfaceC12338e) || !C3335k.m11455a(cardDetailsSectionSpec.getApiPath(), IdentifierSpec.Companion.Generic("card_details"))) {
            z = true;
        } else {
            z = false;
        }
        if (z) {
            interfaceC0273c.mo12510i(interfaceC12338e, 0, IdentifierSpec$$serializer.INSTANCE, cardDetailsSectionSpec.getApiPath());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof CardDetailsSectionSpec) && C3335k.m11455a(getApiPath(), ((CardDetailsSectionSpec) obj).getApiPath());
    }
    ...
    public String toString() {
        StringBuilder m14987g = C0048o.m14987g("CardDetailsSectionSpec(apiPath=");
    ...
    public /* synthetic */ CardDetailsSectionSpec(IdentifierSpec identifierSpec, int i, C3330f c3330f) {

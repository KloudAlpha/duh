...
public final class InvalidRequestException extends StripeException {
    ...
    */
    public /* synthetic */ InvalidRequestException(StripeError stripeError, String str, int i, String str2, Throwable th2, int i2, C3330f c3330f) {
    ...
    public InvalidRequestException(StripeError stripeError, String str, int i, String str2, Throwable th2) {

...
public class AsyncHttpClient {
    ...
    public static void endEntityViaReflection(HttpEntity httpEntity) {
        if (httpEntity instanceof HttpEntityWrapper) {
            ...
            try {
                ...
                log.mo11839e(LOG_TAG, "wrappedEntity consume", th2);
            }
        }
    }
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean z, int i, int i2) {
        ...
        if (z) {
            log.mo11842d(LOG_TAG, "Beware! Using the fix is insecure, as it doesn't verify SSL certificates.");
        }
        if (i < 1) {
            i = 80;
            log.mo11842d(LOG_TAG, "Invalid HTTP port number specified, defaulting to 80");
        }
        if (i2 < 1) {
            i2 = 443;
            log.mo11842d(LOG_TAG, "Invalid HTTPS port number specified, defaulting to 443");
        }
        if (z) {
    ...
    public static String getUrlWithQueryString(boolean z, String str, RequestParams requestParams) {
        ...
        if (z) {
            try {
                ...
                log.mo11839e(LOG_TAG, "getUrlWithQueryString encoding URL", e);
            }
        }
        if (requestParams != null) {
            ...
            if (!trim.equals("")) {
                ...
                if (!trim.equals("?")) {
                    ...
                    m14987g.append(str2);
                    return C0118m0.m14943b(m14987g.toString(), trim);
                }
                return str;
            }
            return str;
    ...
    public static void silentCloseInputStream(InputStream inputStream) {
        if (inputStream != null) {
            try {
                ...
                log.mo11833w(LOG_TAG, "Cannot close input stream", e);
            }
        }
    }
    ...
    public static void silentCloseOutputStream(OutputStream outputStream) {
        if (outputStream != null) {
            try {
                ...
                log.mo11833w(LOG_TAG, "Cannot close output stream", e);
            }
        }
    }
    ...
    public void cancelRequests(Context context, final boolean z) {
        if (context == null) {
            log.mo11840e(LOG_TAG, "Passed null Context to cancelRequests");
            return;
        }
    ...
    public void cancelRequestsByTAG(Object obj, boolean z) {
        if (obj == null) {
            log.mo11842d(LOG_TAG, "cancelRequestsByTAG, passed TAG is null, cannot proceed");
            return;
        }
        for (List<RequestHandle> list : this.requestMap.values()) {
            if (list != null) {
            ...
            if (responseHandlerInterface != null) {
                ...
                if (str != null) {
                    if ((httpUriRequest instanceof HttpEntityEnclosingRequestBase) && ((HttpEntityEnclosingRequestBase) httpUriRequest).getEntity() != null && httpUriRequest.containsHeader("Content-Type")) {
                        log.mo11834w(LOG_TAG, "Passed contentType will be ignored because HttpEntity sets content type");
                    } else {
    ...
    public void setCredentials(AuthScope authScope, Credentials credentials) {
        if (credentials == null) {
            log.mo11842d(LOG_TAG, "Provided credentials are null, not setting");
            return;
        }
            ...
            public void process(HttpRequest httpRequest, HttpContext httpContext) {
                ...
                for (String str : AsyncHttpClient.this.clientHeaderMap.keySet()) {
                    if (httpRequest.containsHeader(str)) {
                        ...
                        AsyncHttpClient.log.mo11842d(AsyncHttpClient.LOG_TAG, String.format("Headers were overwritten! (%s | %s) overwrites (%s | %s)", str, AsyncHttpClient.this.clientHeaderMap.get(str), firstHeader.getName(), firstHeader.getValue()));

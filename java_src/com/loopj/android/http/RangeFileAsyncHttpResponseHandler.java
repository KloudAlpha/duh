...
public abstract class RangeFileAsyncHttpResponseHandler extends FileAsyncHttpResponseHandler {
        ...
        if (!Thread.currentThread().isInterrupted()) {
            ...
            if (statusLine.getStatusCode() == 416) {
                ...
                if (firstHeader == null) {
                    ...
                    StringBuilder m14987g = C0048o.m14987g("Content-Range: ");
                    m14987g.append(firstHeader.getValue());
                    logInterface.mo11836v(LOG_TAG, m14987g.toString());
                }
    ...
    public void updateRequestHeaders(HttpUriRequest httpUriRequest) {
        ...
        if (this.current > 0) {
            ...
            m14987g.append("-");
            httpUriRequest.setHeader("Range", m14987g.toString());
        }
    }
}

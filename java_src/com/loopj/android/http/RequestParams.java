...
public class RequestParams implements Serializable {
    ...
    public final ConcurrentSkipListMap<String, List<FileWrapper>> fileArrayParams;
    public final ConcurrentSkipListMap<String, FileWrapper> fileParams;
    public boolean forceMultipartEntity;
    public boolean isRepeatable;
    public final ConcurrentSkipListMap<String, StreamWrapper> streamParams;
    public final ConcurrentSkipListMap<String, String> urlParams;
    public final ConcurrentSkipListMap<String, Object> urlParamsWithObjects;
    ...
    private HttpEntity createFormEntity() {
        try {
            ...
            AsyncHttpClient.log.mo11839e(LOG_TAG, "createFormEntity failed", e);
            return null;
        }
    }
    ...
    public void setContentEncoding(String str) {
        if (str != null) {
            ...
            AsyncHttpClient.log.mo11842d(LOG_TAG, "setContentEncoding called with null attribute");
        }
    }

...
# direct methods
.method public constructor <init>(Lih/c0;I)V
    .locals 1

    const/4 v0, -0x1

    invoke-direct {p0, p1, p2, v0, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Lih/c0;III)V

    return-void
.end method

.method public constructor <init>(Lih/c0;II)V
    .locals 1

    const/4 v0, -0x1

    invoke-direct {p0, p1, p2, p3, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Lih/c0;III)V

    return-void
.end method

.method public constructor <init>(Lih/c0;III)V
    .locals 3
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lih/c0;
...
.method public engineDoFinal([BII[BI)I
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lih/c0;
    ...
    invoke-interface/range {v2 .. v7}, Lih/c0;->processBytes([BII[BI)I

    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lih/c0;

    invoke-interface {p1}, Lih/c0;->reset()V
...
.method public engineDoFinal([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lih/c0;

    invoke-interface {p2}, Lih/c0;->reset()V
...
.method public engineGetIV()[B
    ...
    .line 1
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Lwh/z0;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    .line 26
    .line 27
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lih/c0;

    .line 28
    .line 29
    invoke-interface {v0}, Lih/c0;->getAlgorithmName()Ljava/lang/String;
    ...
    .line 117
    .line 118
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Lwh/z0;
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    :cond_0
    invoke-virtual {p2}, Lgi/i;->getEncoded()[B
    ...
    invoke-interface {p2}, Lih/c0;->getAlgorithmName()Ljava/lang/String;

    move-result-object v9

    invoke-static/range {v3 .. v9}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lih/h;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getOID()Lhg/o;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Lwh/z0;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Lwh/z0;
    ...
    .line 8
    invoke-direct {p4, p2, v3, v2, p3}, Lwh/z0;-><init>(Lih/h;[BII)V

    .line 9
    iput-object p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:Lwh/z0;
    ...
    invoke-interface {p1, v2, p2}, Lih/c0;->init(ZLih/h;)V
    ...
    invoke-interface {p1, v1, p2}, Lih/c0;->init(ZLih/h;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public engineUpdate([BII)[B
    ...
    invoke-interface/range {v0 .. v5}, Lih/c0;->processBytes([BII[BI)I

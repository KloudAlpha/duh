...
.method public constructor <init>(Lth/b;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lth/b;

    return-void
.end method

.method public static synthetic access$000(Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;)Lth/b;
    .locals 0

    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lth/b;
...
.method public doFinal([BI)I
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseBlockCipher$AEADGenericBlockCipher;->cipher:Lth/b;

    invoke-interface {v0, p1, p2}, Lth/b;->doFinal([BI)I
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    instance-of v1, v0, Lth/a;

    if-eqz v1, :cond_0

    check-cast v0, Lth/a;

    invoke-interface {v0}, Lth/a;->getUnderlyingCipher()Lih/d;
    ...
    :cond_0
    invoke-interface {v0}, Lth/b;->getAlgorithmName()Ljava/lang/String;
...
.method public getOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Lth/b;->getOutputSize(I)I
...
.method public getUpdateOutputSize(I)I
    ...
    invoke-interface {v0, p1}, Lth/b;->getUpdateOutputSize(I)I
...
.method public init(ZLih/h;)V
    ...
    invoke-interface {v0, p1, p2}, Lth/b;->init(ZLih/h;)V
...
.method public processByte(B[BI)I
    ...
    invoke-interface {v0, p1, p2, p3}, Lth/b;->processByte(B[BI)I
...
.method public processBytes([BII[BI)I
    ...
    invoke-interface/range {v0 .. v5}, Lth/b;->processBytes([BII[BI)I
...
.method public updateAAD([BII)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lth/b;->b([BII)V

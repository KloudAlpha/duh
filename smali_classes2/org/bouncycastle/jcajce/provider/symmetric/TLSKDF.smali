...
.method private static PRF_legacy(Lji/t;)[B
    .locals 2
    ...
    .line 27
    invoke-static {p0}, Lrj/k;->c(Ljava/lang/String;)[B
...
.method public static synthetic access$000(Lji/t;)[B
    .locals 0

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->PRF_legacy(Lji/t;)[B
...
.method public static synthetic access$100(Lih/u;[B[B[B)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->hmac_hash(Lih/u;[B[B[B)V

    return-void
.end method

.method private static hmac_hash(Lih/u;[B[B[B)V
    .locals 8
    ...
    .line 5
    invoke-direct {v0, p1, v2, v1}, Lwh/v0;-><init>([BII)V

    .line 6
    .line 7
    .line 8
    invoke-interface {p0, v0}, Lih/u;->init(Lih/h;)V

    .line 9
    .line 10
    .line 11
    invoke-interface {p0}, Lih/u;->getMacSize()I
    ...
    .line 37
    invoke-interface {p0, v6, v2, v7}, Lih/u;->update([BII)V

    .line 38
    .line 39
    .line 40
    invoke-interface {p0, v3, v2}, Lih/u;->doFinal([BI)I

    .line 41
    .line 42
    .line 43
    invoke-interface {p0, v3, v2, v1}, Lih/u;->update([BII)V
    ...
    .line 47
    invoke-interface {p0, p2, v2, v6}, Lih/u;->update([BII)V

    .line 48
    .line 49
    .line 50
    invoke-interface {p0, v4, v2}, Lih/u;->doFinal([BI)I

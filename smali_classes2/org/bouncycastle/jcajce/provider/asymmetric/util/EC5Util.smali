...
.method public static constructor <clinit>()V
    ...
    .line 40
    iget-object v1, v1, Lhh/h;->c:Lqi/d;
    ...
    .line 47
    .line 48
    invoke-static {v0}, Lmh/a;->e(Ljava/lang/String;)Lhh/h;
    ...
    .line 52
    iget-object v0, v0, Lhh/h;->c:Lqi/d;
    ...
    .line 57
    .line 58
    iget-object v2, v0, Lqi/d;->a:Lxi/a;

    .line 59
    .line 60
    invoke-interface {v2}, Lxi/a;->c()Ljava/math/BigInteger;
    ...
    .line 76
    iget-object v6, v0, Lqi/d;->d:Ljava/math/BigInteger;

    .line 77
    .line 78
    iget-object v7, v0, Lqi/d;->e:Ljava/math/BigInteger;
    ...
    .line 81
    invoke-direct/range {v2 .. v7}, Lqi/d$d;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static convertCurve(Lqi/d;[B)Ljava/security/spec/EllipticCurve;
    .locals 3

    .line 1
    iget-object p1, p0, Lqi/d;->a:Lxi/a;

    .line 2
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertField(Lxi/a;)Ljava/security/spec/ECField;
    ...
    .line 5
    iget-object p0, p0, Lqi/d;->c:Lqi/f;
...
.method public static convertCurve(Ljava/security/spec/EllipticCurve;)Lqi/d;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lqi/d$c;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object v0
.end method

.method public static convertField(Lxi/a;)Ljava/security/spec/ECField;
    .locals 6

    .line 1
    invoke-interface {p0}, Lxi/a;->b()I
    ...
    .line 15
    .line 16
    invoke-interface {p0}, Lxi/a;->c()Ljava/math/BigInteger;
    ...
    .line 25
    .line 26
    invoke-interface {p0}, Lxi/e;->a()Lxi/c;
    ...
    .line 86
    .line 87
    invoke-direct {v0, p0, v3}, Ljava/security/spec/ECFieldF2m;-><init>(I[I)V
...
.method public static convertPoint(Lqi/g;)Ljava/security/spec/ECPoint;
    .locals 2
...
.method public static convertPoint(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;)Lqi/g;
    .locals 0
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Ljava/security/spec/EllipticCurve;)Lqi/d;

    move-result-object p0

    invoke-static {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(Lqi/d;Ljava/security/spec/ECPoint;)Lqi/g;
...
.method public static convertPoint(Lqi/d;Ljava/security/spec/ECPoint;)Lqi/g;
    .locals 1
...
.method public static convertSpec(Ljava/security/spec/EllipticCurve;Loi/e;)Ljava/security/spec/ECParameterSpec;
    .locals 7
    ...
    .line 3
    iget-object v2, v0, Loi/c;->f:Ljava/lang/String;

    .line 4
    new-instance v0, Loi/d;

    .line 5
    iget-object v5, p1, Loi/e;->d:Ljava/math/BigInteger;

    .line 6
    iget-object v6, p1, Loi/e;->e:Ljava/math/BigInteger;
    ...
    .line 7
    invoke-direct/range {v1 .. v6}, Loi/d;-><init>(Ljava/lang/String;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    .line 8
    iget-object v1, p1, Loi/e;->d:Ljava/math/BigInteger;
...
.method public static convertSpec(Ljava/security/spec/ECParameterSpec;)Loi/e;
    .locals 9
    ...
    .line 12
    invoke-direct/range {v1 .. v7}, Loi/c;-><init>(Ljava/lang/String;Lqi/d;Lqi/g;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    return-object v8

    :cond_0
    new-instance p0, Loi/e;
    ...
    invoke-direct/range {v1 .. v6}, Loi/e;-><init>(Lqi/d;Lqi/g;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    return-object p0
.end method

.method public static convertToSpec(Lhh/f;Lqi/d;)Ljava/security/spec/ECParameterSpec;
    .locals 8

    .line 1
    iget-object p0, p0, Lhh/f;->b:Lhg/t;
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/ECUtil;->getNamedCurveByOid(Lhg/o;)Lhh/h;
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Lqi/d;[B)Ljava/security/spec/EllipticCurve;

    move-result-object v4

    new-instance p1, Loi/d;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/ECUtil;->getCurveName(Lhg/o;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(Lqi/g;)Ljava/security/spec/ECPoint;

    move-result-object v5

    .line 4
    iget-object v6, v0, Lhh/h;->q:Ljava/math/BigInteger;

    .line 5
    iget-object v7, v0, Lhh/h;->x:Ljava/math/BigInteger;

    move-object v2, p1

    .line 6
    invoke-direct/range {v2 .. v7}, Loi/d;-><init>(Ljava/lang/String;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-static {p0}, Lhh/h;->y(Lhg/t;)Lhh/h;
    ...
    .line 9
    iget-object v0, p0, Lhh/h;->x:Ljava/math/BigInteger;
    ...
    .line 12
    iget-object p0, p0, Lhh/h;->x:Ljava/math/BigInteger;
    ...
    .line 14
    iget-object p0, p0, Lhh/h;->q:Ljava/math/BigInteger;
    ...
    :cond_4
    invoke-static {p0}, Llg/f;->x(Lhg/e;)Llg/f;

    move-result-object p0

    .line 16
    iget-object p1, p0, Llg/f;->b:Lhg/o;
    ...
    .line 19
    iget-object v1, p1, Loi/e;->b:[B

    .line 20
    invoke-static {v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Lqi/d;[B)Ljava/security/spec/EllipticCurve;
    ...
    .line 21
    iget-object p0, p0, Llg/f;->b:Lhg/o;

    .line 22
    invoke-static {p0}, Llg/b;->c(Lhg/o;)Ljava/lang/String;

    move-result-object v3

    .line 23
    iget-object p0, p1, Loi/e;->c:Lqi/g;
    ...
    .line 25
    iget-object v6, p1, Loi/e;->d:Ljava/math/BigInteger;

    .line 26
    iget-object v7, p1, Loi/e;->e:Ljava/math/BigInteger;
...
.method public static convertToSpec(Lhh/h;)Ljava/security/spec/ECParameterSpec;
    .locals 4
...
.method public static convertToSpec(Lwh/w;)Ljava/security/spec/ECParameterSpec;
    .locals 4
    ...
    .line 35
    iget-object v2, p0, Lwh/w;->d:Lqi/g;
    ...
    .line 38
    iget-object p0, p0, Lwh/w;->x:Ljava/math/BigInteger;
...
.method public static getCurve(Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;Lhh/f;)Lqi/d;
    .locals 2
    ...
    .line 53
    :cond_2
    iget-object p0, v0, Lhh/h;->c:Lqi/d;
    ...
    .line 64
    iget-object p0, p0, Loi/e;->a:Lqi/d;
    ...
    .line 90
    invoke-virtual {p0, p1}, Lhg/v;->K(I)Lhg/e;
    ...
    .line 94
    invoke-static {p0}, Lhg/o;->L(Ljava/lang/Object;)Lhg/o;
    ...
    .line 98
    invoke-static {p0}, Llg/b;->b(Lhg/o;)Lhh/h;
    ...
    .line 102
    :goto_1
    iget-object p0, p0, Lhh/h;->c:Lqi/d;
...
.method public static getDomainParameters(Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;Ljava/security/spec/ECParameterSpec;)Lwh/w;
    .locals 6
    ...
    .line 28
    invoke-static {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/ECUtil;->getDomainParameters(Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;Loi/e;)Lwh/w;

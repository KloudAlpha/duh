...
.method public readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->setBagAttribute(Lhg/o;Lhg/e;)V
...
.method public writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    .line 32
    .line 33
    invoke-direct {v1, v0}, Lhg/r;-><init>(Ljava/io/OutputStream;)V
    ...
    .line 57
    invoke-virtual {v1, v3, v4}, Lhg/r;->l(Lhg/t;Z)V
    ...
    .line 67
    .line 68
    invoke-virtual {v1, v3}, Lhg/r;->k(Lhg/e;)V

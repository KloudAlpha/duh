...
# instance fields
.field private final bcHelper:Lki/c;

.field private currentCrlStream:Ljava/io/InputStream;

.field private currentStream:Ljava/io/InputStream;

.field private sCrlData:Lhg/y;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lki/c;

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lhg/y;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lhg/y;
...
.method private doGenerateCRL(Ljava/io/InputStream;Z)Ljava/security/cert/CRL;
    ...
    .line 8
    .line 9
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lhg/y;
    ...
    :goto_1
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lhg/y;
    ...
    .line 22
    .line 23
    iget-object p2, v0, Lhg/y;->b:[Lhg/e;
    ...
    .line 85
    invoke-direct {p2, p1, v1, v0}, Lhg/k;-><init>(Ljava/io/InputStream;IZ)V

    .line 86
    .line 87
    .line 88
    invoke-direct {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->readDERCRL(Lhg/k;)Ljava/security/cert/CRL;
...
.method private doGenerateCertificate(Ljava/io/InputStream;Z)Ljava/security/cert/Certificate;
    ...
    .line 11
    .line 12
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lhg/y;
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lhg/y;
    ...
    .line 82
    .line 83
    invoke-direct {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->readDERCertificate(Lhg/k;)Ljava/security/cert/Certificate;
...
.method private getCRL()Ljava/security/cert/CRL;
    ...
    .line 5
    invoke-static {v0}, Lgh/o;->x(Ljava/lang/Object;)Lgh/o;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->createCRL(Lgh/o;)Ljava/security/cert/CRL;
...
.method private getCRL(Lhg/v;)Ljava/security/cert/CRL;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    :cond_2
    :goto_0
    iget-object p1, v0, Lzg/w;->x:Lhg/y;

    .line 8
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sCrlData:Lhg/y;
    ...
    :cond_3
    invoke-static {p1}, Lgh/o;->x(Ljava/lang/Object;)Lgh/o;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->createCRL(Lgh/o;)Ljava/security/cert/CRL;
...
.method private getCertificate()Ljava/security/cert/Certificate;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lhg/y;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lki/c;

    invoke-static {v0}, Lgh/n;->x(Ljava/lang/Object;)Lgh/n;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;-><init>(Lki/c;Lgh/n;)V
...
.method private getCertificate(Lhg/v;)Ljava/security/cert/Certificate;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    .line 8
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->sData:Lhg/y;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->bcHelper:Lki/c;

    invoke-static {p1}, Lgh/n;->x(Ljava/lang/Object;)Lgh/n;

    move-result-object p1

    invoke-direct {v0, v1, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;-><init>(Lki/c;Lgh/n;)V

    return-object v0
.end method

.method private readDERCRL(Lhg/k;)Ljava/security/cert/CRL;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->getCRL(Lhg/v;)Ljava/security/cert/CRL;
...
.method private readDERCertificate(Lhg/k;)Ljava/security/cert/Certificate;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->getCertificate(Lhg/v;)Ljava/security/cert/Certificate;
...
.method private readPEMCRL(Ljava/io/InputStream;Z)Ljava/security/cert/CRL;
    ...
    invoke-virtual {v0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;->readPEMObject(Ljava/io/InputStream;Z)Lhg/v;
...
# virtual methods
.method public createCRL(Lgh/o;)Ljava/security/cert/CRL;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-direct {v0, v1, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLObject;-><init>(Lki/c;Lgh/o;)V

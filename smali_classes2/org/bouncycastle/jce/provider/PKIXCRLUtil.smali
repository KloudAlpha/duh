...
.method public static findCRLs(Lgi/m;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Lgi/m;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;Lgi/m;Ljava/util/List;)V
    :try_end_0
    ...
    .line 1
    :cond_1
    iget-object v1, p0, Lgi/m;->b:Ljava/security/cert/CRLSelector;
...
.method private static findCRLs(Ljava/util/HashSet;Lgi/m;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-interface {v2, p1}, Lrj/i;->getMatches(Lrj/h;)Ljava/util/Collection;
    ...
    .line 4
    :try_start_1
    new-instance v3, Lgi/m$b;

    invoke-direct {v3, p1}, Lgi/m$b;-><init>(Lgi/m;)V

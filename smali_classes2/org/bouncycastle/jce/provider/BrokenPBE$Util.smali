...
.method private static makePBEGenerator(II)Lih/x;
    ...
    invoke-direct {p0, v0, p1}, Lqh/q;-><init>(ILih/p;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jce/provider/OldPKCS12ParametersGenerator;-><init>(Lih/p;)V
...
.method public static makePBEMacParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;III)Lih/h;
    .locals 1
    ...
    invoke-static {p2, p3}, Lorg/bouncycastle/jce/provider/BrokenPBE$Util;->makePBEGenerator(II)Lih/x;
    ...
    invoke-virtual {p2, p0, p3, p1}, Lih/x;->init([B[BI)V

    invoke-virtual {p2, p4}, Lih/x;->generateDerivedMacParameters(I)Lih/h;
...
.method public static makePBEParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;IILjava/lang/String;II)Lih/h;
    .locals 1
    ...
    .line 29
    .line 30
    invoke-virtual {p2, p5, p6}, Lih/x;->generateDerivedParameters(II)Lih/h;
    ...
    .line 35
    :cond_0
    invoke-virtual {p2, p5}, Lih/x;->generateDerivedParameters(I)Lih/h;

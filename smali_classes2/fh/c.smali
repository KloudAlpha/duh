...
.method public static constructor <clinit>()V
    ...
    invoke-static {v1}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v1

    const-string v2, "2.5.4.3"

    invoke-static {v2}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v2

    const-string v3, "0.9.2342.19200300.100.1.25"

    invoke-static {v3}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v3

    const-string v4, "2.5.4.13"

    invoke-static {v4}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v4

    const-string v5, "2.5.4.27"

    invoke-static {v5}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v5

    const-string v6, "2.5.4.49"

    invoke-static {v6}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v6

    const-string v7, "2.5.4.46"

    invoke-static {v7}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v7

    const-string v8, "2.5.4.47"

    invoke-static {v8}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v8

    const-string v9, "2.5.4.23"

    invoke-static {v9}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v9

    const-string v10, "2.5.4.44"

    invoke-static {v10}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v10

    const-string v11, "2.5.4.42"

    invoke-static {v11}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v11

    const-string v12, "2.5.4.51"

    invoke-static {v12}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v12

    const-string v13, "2.5.4.43"

    invoke-static {v13}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v13

    const-string v14, "2.5.4.25"

    invoke-static {v14}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;

    move-result-object v14

    const-string v15, "2.5.4.7"

    invoke-static {v15}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;
    ...
    invoke-static/range {v16 .. v16}, Landroidx/activity/m;->h(Ljava/lang/String;)Lhg/o;
    ...
    sput-object v15, Lfh/c;->g:Ljava/util/Hashtable;
    ...
    sput-object v14, Lfh/c;->h:Ljava/util/Hashtable;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lfh/c;->g:Ljava/util/Hashtable;

    invoke-static {v0}, La9/d;->T0(Ljava/util/Hashtable;)Ljava/util/Hashtable;

    move-result-object v0

    iput-object v0, p0, Lfh/c;->e:Ljava/util/Hashtable;

    sget-object v0, Lfh/c;->h:Ljava/util/Hashtable;
...
# virtual methods
.method public final h(Leh/c;)Ljava/lang/String;
    .locals 5
    ...
    iget-object v4, p0, Lfh/c;->e:Ljava/util/Hashtable;

    invoke-static {v0, v3, v4}, Lhe/w;->j(Ljava/lang/StringBuffer;Leh/b;Ljava/util/Hashtable;)V

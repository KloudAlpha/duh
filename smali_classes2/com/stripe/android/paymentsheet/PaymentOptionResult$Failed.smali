...
.method public static constructor <clinit>()V
    ...
    sput v0, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->$stable:I
...
.method public constructor <init>(Ljava/lang/Throwable;Ljava/util/List;)V
    ...
    .line 4
    iput-object p2, p0, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->paymentMethods:Ljava/util/List;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/Throwable;Ljava/util/List;ILdf/f;)V
    .locals 0
    ...
    .line 1
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;-><init>(Ljava/lang/Throwable;Ljava/util/List;)V

    return-void
.end method

.method public static synthetic copy$default(Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;Ljava/lang/Throwable;Ljava/util/List;ILjava/lang/Object;)Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;
    .locals 0
    ...
    invoke-virtual {p0}, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->getPaymentMethods()Ljava/util/List;

    move-result-object p2

    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->copy(Ljava/lang/Throwable;Ljava/util/List;)Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;
...
.method public final copy(Ljava/lang/Throwable;Ljava/util/List;)Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2}, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;-><init>(Ljava/lang/Throwable;Ljava/util/List;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->error:Ljava/lang/Throwable;
    ...
    invoke-virtual {p1}, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->getPaymentMethods()Ljava/util/List;
...
.method public getPaymentMethods()Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lcom/stripe/android/paymentsheet/PaymentOptionResult$Failed;->paymentMethods:Ljava/util/List;
